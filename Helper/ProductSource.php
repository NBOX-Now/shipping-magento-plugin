...
class ProductSource
{
     ...
     * @return array The source location details or an error message.
     */
     ...
     *
     * @param string $sourceCode The source code for the location.
     * @return array The source details or an error message.
     */
